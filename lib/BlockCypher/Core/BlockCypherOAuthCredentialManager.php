...
/**
 * Class BlockCypherOAuthCredentialManager
 *
 * BlockCypherCredentialManager holds all the credential information in one place.
 *
 * @package BlockCypher\Core
 */
class BlockCypherOAuthCredentialManager extends BlockCypherCredentialManager
{
    // TODO: remove code present in parent class
