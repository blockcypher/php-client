...
class SignerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function should_allow_sign_data_with_hex_private_key()
    {
    ...
    public function should_sign_data_deterministically()
    {
    ...
    public function should_allow_sign_multiple_data_at_once()
    {
