...
/**
 * Class FundMultisignAddressTransactionTest
 * @package sample\Test\Functional\transaction
 */
class FundMultisignAddressTransactionTest extends WebTestCase
{
    ...
    public function testFundMultisignAddressTransaction()
    {
