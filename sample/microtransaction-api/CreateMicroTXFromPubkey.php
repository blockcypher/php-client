...
// # Create, Sign and Send MicroTX Sample (client-side signing)
//
...
// ### Create, Sign and Send a MicroTX (client-side signing)
try {
    $microTX = \BlockCypher\Client\MicroTXClient::sendSigned(
